...
class Operations extends Component {
    ...
    render() {
        return (<div>
            <h2>Operations</h2>
            <input name="amount" type="number" placeholder="Amount" onChange={this.handleInput}></input><br></br>
            <input name="vendor" type="text" placeholder="Vendor" onChange={this.handleInput}></input><br></br>
            <input name="category" type="text" placeholder="Category" onChange={this.handleInput}></input><br></br>
